        ...
        <div class="col-7 mx-auto">
            ...
            <form action="{{ route('checkout') }}" method="POST" id="checkout-form">
                ...
                <div class="row ">
                    ...
                    <div class="col-12">
                        <label for="phonenumber" class="">{{ __('Numero telefónico') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-12">
                        <label for="country" class="">{{ __('País') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-12">
                        <label for="city" class="">{{ __('Ciudad') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-12">
                        <label for="creditcardnumber" class="">{{ __('Número de tarjeta de crédito') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-6">
                        <label for="expiremonth" class="">{{ __('Mes de expiración') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-6">
                        <label for="expireyear" class="">{{ __('Año de expiración') }}</label>
                        <div class="form-group">
                            <div>
                ...
                <button type="submit" class="button-primary w-100">COMPRA AHORA</button>
