...
<head>
    ...
    <!-- Styles -->
    <link rel="icon" href="{{ URL::asset('photo/Logo1.png') }}" type="image/x-icon"/>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        <div><img src="{{ asset('photo/Logo.png') }}" style="height:75px;" alt=""></div>
                        <div class="pl-3 ml-3 pt-2"></div>
                    </div>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="{{ route('order.show',['user'=>Auth::user()->id]) }}" class="dropdown-item">Historial de compras</a>
                                    @endif
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>Jahir Enrique  <br> Herrera Molina <br> +523 983188356  <br> jahirherrera27@gmail.com</p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Suigamos en:</h3>
                        <ul>
                    ...
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <div class='newsletter-form p-0'>
                            <form action='{{ route('newsletter.add') }}' method='post' id='newsletter-validate-detail'>
                                ...
                                <button type='submit' id='signup-newsletter-footer' class='button'>INSCRIBIRSE</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>LettyShop</p>
                        <p> Company&copy; 2021. All Rights Reserved</p>
                    </div>
