...
<div class="container p-0">
  ...
  <!-- GET FIT FROM HOME [S]-->
        ...
        <div class="row m-0 p-0">
          <div class="col-4 promo-info h-100">
            <div class="infowrapper d-flex flex-column h-100 justify-content-center">
              <h2>PONTE EN FORMA DESDE CASA</h2>
              <h4>¡30% de descuento en todos los artículos listados!</h4>
              <p>La oferta finaliza el 23 de junio de 2021</p>
              <a href="{{ route('product.index') }}" class="w-100 button">COMPRA AHORA</a>
            </div>
          </div>
        </div>
        <img class="d-block w-100" src="{{ asset('photo/banner1.png') }}" alt="">
      </div>
    </div>
    <!-- GET FIT FROM HOME [E]-->
    ...
    <div class="row pt-4">
      <div class="col-6 d-flex flex-column align-items-center genderwrapper">
        <a href="{{ route('product.index') }}">
          <button id="maleBtn">
          <div class="gender">
            <img class="d-block w-100" src="{{ asset('photo/modelo2.png') }}" alt="">
            <h2 class="pt-2">HOMBRE</h2>
          </div>
        </button>
        </a>
      </div>
      <div class="col-6 d-flex flex-column align-items-center genderwrapper">
        <a href="{{ route('product.index') }}">
          <button id="femaleBtn">
          <div class="gender">
            <img class="d-block w-100" src="{{ asset('photo/modelo1.png') }}" alt="">
            <h2 class="pt-2">MUJER</h2>
          </div>
        </button>
        </a>
      </div>
    ...
    <!-- MEN & WOMEN [E]-->
        ...
        <div class="row m-0 pt-4">
          ...
          <div class="col-lg-4 col-sm-12 d-flex flex-column align-items-center categorywrapper">
            <a href="{{ route('product.index') }}">
              <div class="category">
                <img class="" height="200px" src="{{ asset('photo/11.jpg') }}" alt="">
                <h5 class="pt-2">PUMA</h5>
            </div>
            </a>
          </div>
          <div class="col-lg-4 col-sm-12 d-flex flex-column align-items-center categorywrapper">
            <a href="{{ route('product.index') }}">
              <div class="category">
                <img class="" height="200px" src="{{ asset('photo/13.jpg') }}" alt="">
                <h5 class="pt-2">CONVERSE</h5>
              </div>
            </a>
          </div>
        </div>
    ...
    <!-- FEATURED SHOES [S]-->
    <h2 class="pt-4">MEJOR VENDIDO</h2>
    ...
    <!-- ADVANTAGE [S]-->
    <h2 class="pt-4">NUESTRO COMPROMISO</h2>
    <div class="row m-0 pt-4">
