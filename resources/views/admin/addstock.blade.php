...
<div class="col-12 col-md-12 col-sm-12 col-lg-10">
    ...
    <form method="POST" action="{{ route('admin.addstock')}}" enctype="multipart/form-data">
        ...
        <div class="row ">
            ...
            <div class="col-12">
                <label for="product" class="">{{ __('Producto') }}</label>
                <div class="form-group">
                    <select name="product" id="addproductstock" class="form-control">
                        <option selected="true" value="" disabled hidden>Selecciona producto</option>
            ...
            <div class="col-12">
                <label for="size" class="">{{ __('Tamaño') }}</label>
                <div class="form-group">
                    <div>
            ...
            <div class="col-12">
                <label for="quantity" class="">{{ __('Cantidad') }}</label>
                <div class="form-group">
                    <div>
